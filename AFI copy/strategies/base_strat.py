...
class BaseStrategy(ABC):
    ...
    def set_market_analyzer(self, market_analyzer):
        """Sets the market analyzer for the strategy."""
    ...
    def generate_entry_signal(self, token: str, analysis: Dict) -> Optional[Dict]:
        """Generate a rich entry signal dictionary or None."""
        pass

    @abstractmethod
    def generate_exit_signal(self, token: str, analysis: Dict, position: Dict) -> Optional[Dict]:
        """Generate a rich exit signal dictionary or None."""
        pass
